...
==============================================================================*/
#ifndef TENSORFLOW_LITE_DELEGATES_ENUM_MAPPING_H_
...
inline TfLiteType SchemaTypeToTfLiteType(TensorType type) {
  switch (type) {
...
#endif  // TENSORFLOW_LITE_DELEGATES_ENUM_MAPPING_H_
